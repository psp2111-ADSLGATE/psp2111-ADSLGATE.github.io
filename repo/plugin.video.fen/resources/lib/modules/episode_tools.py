...
get_icon, addon_fanart, fen_clearlogo = kodi_utils.get_icon, kodi_utils.addon_fanart, kodi_utils.addon_clearlogo
...
def build_next_episode_manager():
	def _process(item):
		try:
			...
			listitem.setArt({'poster': icon, 'fanart': addon_fanart, 'icon': icon, 'clearlogo': fen_clearlogo})
