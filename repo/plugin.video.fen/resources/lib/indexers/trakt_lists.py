...
trakt_icon, fanart, fen_clearlogo, add_item, set_property = get_icon('trakt'), kodi_utils.addon_fanart, kodi_utils.addon_clearlogo, kodi_utils.add_item, kodi_utils.set_property
