...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = '[COLOR FFFE9900][B]Archive[/B][/COLOR]Wizard'
BUILDERNAME = 'OpenWizard'
EXCLUDES = [ADDON_ID, 'repository.openwizard']
# Text File with build info in it. Please read https://github.com/a4k-openproject/plugin.program.openwizard/wiki/Installing-Builds
BUILDFILE = 'https://archive.org/download/builds_202308/Builds.txt'
...
THEME1 = u'[COLOR {color1}][I]([COLOR {color1}][B]Archive[/B][/COLOR][COLOR {color2}]Wizard[COLOR {color1}])[/I][/COLOR] [COLOR {color2}]{{}}[/COLOR]'.format(color1=COLOR1, color2=COLOR2)
...
# Font size of header
FONTHEADER = 'Font14'
HEADERMESSAGE = '[COLOR FFFE9900][B]Archive[/B][/COLOR]Wizard'
